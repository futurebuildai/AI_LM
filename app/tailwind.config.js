...
// Industrial Dark design tokens — mirrored from GableRun for cross-repo
// consistency (same fonts, same brand palette, same elevation/glow scales).
export default {
    darkMode: ["class"],
    ...
    theme: {
        extend: {
            ...
            animation: {
                'fade-in': 'fadeIn 0.3s cubic-bezier(0.2, 0.0, 0, 1.0)',
